    ...
    ) : IAuthService
{
    ...
    public async Task<Result<string>> SendConfirmEmailAsync(string email, CancellationToken cancellationToken)
    {
        ...
        var dif = DateTime.UtcNow - user.EmailConfirmedCodeSendDate;
    ...
    public async Task<Result<string>> ChangePasswordWithForgotPasswordCodeAsync(ChangePasswordWithForgotPasswordDto request, CancellationToken cancellationToken)
    {
        ...
        return Result<string>.Succeed("Your password is changed. You can sign in new password");
    ...
    public async Task<Result<string>> SendForgotPasswordEmailAsync(string emailOrUserName, CancellationToken cancellationToken)
    {
        ...
        {
            forgotPasswordCode = random.Next(100000, 999999);
